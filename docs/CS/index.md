...
这里整理计算机基础课和面试常见知识。目标不是把教材全文搬进来，而是把知识点压成可复习、可串联、可查漏补缺的笔记。

## 学习主线

1. 数据结构：先掌握线性表、树、图、查找和排序，再补复杂度分析。
...
- 每个主题先抓“定义、作用、核心机制、常见考点”。
- 遇到算法或协议，补一张流程图或状态变化表。
- 对面试高频问题，单独整理成“问题 - 回答 - 易错点”的形式。
